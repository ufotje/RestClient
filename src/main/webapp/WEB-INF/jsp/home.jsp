            ...
            <div class="card mb-4">
                <div style="overflow: hidden;">
                    ...
                    <div class="card-body" style="z-index: 1;">
                        <div>
                            <h2 class="card-title headerNeutralTitle fontHeader" ><i class="fa fa-film colorRosy"></i> Yayoi Kusama: Life is the heart of a rainbow</h2>
                            ...
                            <div class="row">
                                <div class="col text-left">
                                    <a href="http://www.youtube.be" target="_blank" class="btn btnDef backgroundRosy">Afspelen &rarr;</a>
                                </div>
                                <div class="col text-right colorRosy" style="padding-top: 10px;"></i> 0 <i class="fa fa-thumbs-up" style="margin-right: 10px;"></i> 0 <i class="fa fa-comment" style="margin-right: 10px;"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-footer backgroundRosy colorDarkBrown">Land belgie | postdatum</div>
            </div>
                        ...
                        <c:choose>
                            <c:when test="${objectType == 'story'}">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer backgroundGreen colorDarkBrown">Toegevoegd op ${object.postDate} door Anneleen</div>
                                </div>
                            </c:when>
                                ...
                                <div class="card mb-4 backgroundBlue" style="overflow: hidden;">
                                    ...
                                    <div class="card-body" style="z-index: 1;">
                                        <div>
                                            ...
                                            <p class="card-subtitle mb-2" style="color: #251605;font-style: italic;padding-bottom: 10px;">Van ${object.startDate} tot ${object.endDate}  |  laatste aanpassing ${object.latestEdit}</p>
